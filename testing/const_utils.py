...
CATS_TOP_WORDS = {'chats', 'super'}  # There are more times the word "super" than "chat" in the 1st cluster.
DOGS_TOP_WORDS = {'chiens', 'super'}  # There are more times the word "chiens" than "super" int he 2nd cluster.
